...
export default function AuthLayout({ children, pageType }) {
  ...
  // const [timerVal, setTimerValue] = useState(useCountdown('00:10'))
  const [timer, color, colorPer] = useCountdown('00:10');
            ...
            <Typography variant="h4" gutterBottom className={classes.textCapitalize}>
              ...
              {/* <span
                style={{
                  ...
                  fontSize: '4em',
                  background: `linear-gradient(to bottom, #fff ${100 - colorPer}%, ${color} ${colorPer}%)`,
